...
export default function QuickLogPage() {
  ...
  const [step, setStep] = useState<"capture" | "detail">("capture");
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Land on the property that now holds the record, so the thing just
      // logged is visible rather than requiring another navigation. With
      // no property (a sighting logged off any boundary) the dashboard is
      // the only place that lists it.
